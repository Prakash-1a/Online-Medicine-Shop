...
<p id="W"><b>* RECHARGE YOUR WALLET ---></b></p>
<form>
<center>
<pre>
<form>
<b>
ENTER AMOUNT::  <input type="textbox"name="txt4"placeholder="amount"/><br><br>
ENTER DEBIT CARD NUMBER::  <input type="textbox"name="txt5"placeholder="card number"/><br><br>
CVV::  <input type="password"name="cvv"placeholder="cvv"/><br><br>
<button><a href="otp.php"> Recharge </button></a><br>
</b>
</form>
</center>
</pre>
